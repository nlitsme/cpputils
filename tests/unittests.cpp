...
TEST_CASE("base64") {
    ...
    std::vector<std::tuple<std::vector<uint8_t>, int, std::string>> testcases = {
        ...
        { { 0x00 }, E|D,   "AA==" },
        { { 0x00, 0x00 }, E|D,   "AAA=" },
        { { 0x00, 0x00, 0x00 }, E|D,   "AAAA" },
        { { 0x00, 0x00, 0x00, 0x00 }, E|D,   "AAAAAA==" },
        { { 0x00, 0x00, 0x00, 0x00, 0x00 }, E|D,   "AAAAAAA=" },
        { { 0x00, 0x00, 0x00, 0x00, 0x00 }, D,   "AAAAAAA=\n" },
        { { 0x00, 0x00, 0x00, 0x00, 0x00 }, D,   "AAAA\nAAA=\n" },
        { { 0x00, 0x00, 0x00, 0x00, 0x00 }, D,   "\tAAAA\nAAA=\n" },
        { { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, E|D,   "AAAAAAAA" },
        ...
        { { 0xff, 0xff }, E|D,   "//8=" },
        { { 0xff, 0xff, 0xff }, E|D,   "////" },
        { { 0xff, 0xff, 0xff, 0xff }, E|D,   "/////w==" },
        { { 0xff, 0xff, 0xff, 0xff, 0xff }, E|D,   "//////8=" },
...
{ { 0xff, 0xef, 0x7c, 0xef, 0xae, 0x78, 0xdf, 0x6d, 0x74, 0xcf, 0x2c, 0x70, 0xbe, 0xeb, 0x6c, 0xae, 0xaa, 0x68, 0x9e, 0x69, 0x64, 0x8e, 0x28, 0x60, 0x7d, 0xe7, 0x5c, 0x6d, 0xa6, 0x58, 0x5d, 0x65, 0x54, 0x4d, 0x24, 0x50, 0x3c, 0xe3, 0x4c, 0x2c, 0xa2, 0x48, 0x1c, 0x61, 0x44, 0x0c, 0x20, 0x40 },
E|D, "/+9876543210zyxwvutsrqponmlkjihgfedcbaZYXWVUTSRQPONMLKJIHGFEDCBA" },
...
E|D, "" },
...
E|D, "" },
    ...
    SECTION("types") {
        ...
        CHECK( base64_encode(a) == "AAEC" );

        std::vector<uint8_t> v = { 0, 1, 2 };
        CHECK( base64_encode(v) == "AAEC" );
